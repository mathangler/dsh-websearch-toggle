...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** The shipped entry this component configures. */
    ...
    function apply(ctx) {
      ...
      // The shipped id claims the cell the official Web search page already
      // occupies, so this adds the switch to that entry instead of a new card
      // beside it.
    ...
    exports.__test = { CSS, EN, ZH, NS, ENTRY_ID, enabledOf, settingsPort, WebSearchToggle };
